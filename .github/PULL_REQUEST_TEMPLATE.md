<!-- Lime Station: правила для участников — CONTRIBUTING.md.
...
- [ ] Я прочитал(а) [правила участия в Lime Station](https://github.com/Endennsss/lime-station/blob/master/CONTRIBUTING.md).
